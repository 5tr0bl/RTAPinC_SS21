 ...
 * @var rtap_osc6_tilde::x_obj Necessary for every signal object in Pure Data <br>
 * @var rtap_osc6_tilde::f Also necessary for signal objects, float dummy dataspace <br>
 * for converting a float to signal if no signal is connected (CLASS_MAINSIGNALIN) <br>
 * @var rtap_osc6_tilde::gain The gain object for the actual signal processing <br>
 * @var rtap_osc6_tilde::x_out A signal outlet for the adjusted signal
...
/**
 * @related rtap_osc6_tilde
 * @brief Adds rtap_osc6_tilde_perform to the signal chain. <br>
 * @param x A pointer the rtap_osc6_tilde object <br>
...
/**
 * @related rtap_osc6_tilde
 * @brief Creates a new rtap_osc6_tilde object.<br>
...
/**
 * @related rtap_osc6_tilde
 * @brief Setup of rtap_osc6_tilde <br>
 * For more information please refer to the <a href = "https://github.com/pure-data/externals-howto" > Pure Data Docs </a> <br>
 */
